...
(*
 * Difference an inductive proof that has been broken up into different cases.
 * That is, difference each case separately. In each case,
 * abstract if necessary, then adjust the patch so it type-checks in the
